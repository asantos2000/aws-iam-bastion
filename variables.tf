...
variable "user_data_str" {
  description = "User data content as sring"
}
...
variable "create_eip" {
  description = "Create an attach Elastic IP to the instance"
  default     = false
}

variable "eip_id" {
  description = "Attach Elastic IP to the instance"
}
